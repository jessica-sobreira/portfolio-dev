...
export const Aboutme = () => {
    ...
    <br>
    <p>A constante busca por aperfeiçoamento profissional me levou a uma fascinante transição para a área de Tecnologia da Informação. Recentemente, estive imersa nos estudos de Front-end na renomada escola Alura, além de participar da 15ª edição do Programa Starter da Growdev, focado em Full Stack Development. Paralelamente, estive engajada no Bootcamp Potência Tech iFood da DIO.</p>
    <br>
    ...
    <br>
    <p>Minha trajetória na Growdev foi inspiradora, proporcionando-me a oportunidade de estudar as principais tecnologias exigidas pelo mercado, como HTML, CSS, JavaScript, TypeScript e React.</p>
    <br>
    <p>Atualmente, trabalho na Getnet, uma empresa de tecnologia, onde venho aplicando e expandindo meus conhecimentos profissionais. Estou empolgada com a possibilidade de unir minha bagagem em comunicação à expertise em TI, buscando contribuir de forma inovadora no cenário tecnológico.</p>
    <br>
    <p>Convido você a acompanhar minha jornada de evolução e descobertas!</p>
   </div>
